...
<h3 style="color:#2D1C87;">Frontend Engineering</h3>

<span style="background:#2D1C87; color:white; padding:6px 12px; border-radius:6px; display:inline-block; margin:4px;">React.js</span>
<span style="background:#2D1C87; color:white; padding:6px 12px; border-radius:6px; display:inline-block; margin:4px;">Next.js</span>
